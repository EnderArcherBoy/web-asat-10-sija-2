...
<head>
  ...
  <title>About - <?php echo $row['nama_depan'] ?></title>
  ...
  <header id="header" class="header d-flex align-items-center light-background sticky-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename"><?php echo $row['nama_depan'] ?></h1>
      </a>
    ...
    <section id="about" class="about section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4">
            <img src="upload/<?php echo $row['url_foto'] ?>" class="img-fluid" alt="">
          </div>
          <div class="col-lg-8 content">
            <h2><?php echo $row['profesi'] ?></h2>
            <p class="fst-italic py-3">
              <?php echo $row['deskripsi_profesi'] ?>
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong>
                    <span><?php echo $row['tgl_lahir'] ?></span>
                  </li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong>
                    <span><?php echo $row['website'] ?></span>
                  </li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span><?php echo $row['hp'] ?></span>
                  </li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span><?php echo $row['kota'] ?></span>
                  </li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  ...
                  echo $interval->y;
                  ?></span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong> <span><?php echo $row['gelar']?></span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span><?php echo $row['email']?></span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Freelance:</strong> <span><?php
                  if ($row['freelance'] === '1') {
                    echo 'Available';
                  } else {
                    echo 'Unavailable';
...
<section id="skills" class="skills section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Skills</h2>
        <p> <?php echo htmlspecialchars($row['keterangan_skill']); ?></p>
      </div><!-- End Section Title -->
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row skills-content skills-animation">
          ...
          <?php
          $skillData = explode(',', $row['skill']); // pisahkan berdasarkan koma
          $skills = [];
  ...
  <footer id="footer" class="footer light-background">
    ...
    <div class="container">
      <div class="copyright text-center ">
        <p>© <span>Copyright</span> <strong class="px-1 sitename"><?php echo $row['nama_depan'] ?></strong> <span>All
